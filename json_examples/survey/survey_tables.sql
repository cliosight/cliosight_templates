CREATE TABLE `survey` ( `id` int NOT NULL AUTO_INCREMENT, `fullname` varchar(255) DEFAULT NULL, `email` varchar(255) DEFAULT NULL, `linkedin` varchar(255) DEFAULT NULL, `mobile_country_code` varchar(255) DEFAULT NULL, `mobile_number` varchar(255) DEFAULT NULL, `gender` varchar(255) DEFAULT NULL, `prompt_engg` varchar(255) DEFAULT NULL, `job_role` varchar(255) DEFAULT NULL, `timestamp` varchar(255) DEFAULT NULL, `location` varchar(255) DEFAULT NULL, PRIMARY KEY (`id`) ) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci
